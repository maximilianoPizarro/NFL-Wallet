...
namespace ApiWalletBuffaloBills.Controllers;

[ApiController]
[Route("[controller]")]
public class WalletController : ControllerBase
{
    public const string WalletDisplayName = "Buffalo Bills";
    ...
    /// <summary>Load balance (mock: credit card top-up).</summary>
    ...
    /// <summary>Pay / deduct from balance (e.g. from QR payment).</summary>
