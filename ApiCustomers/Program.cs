...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Stadium Wallet - Customers API", Version = "v1", Description = "Customer data for Stadium Wallet." });
    ...
    c.DocumentFilter<ApiCustomers.SwaggerServersDocumentFilter>();
});
